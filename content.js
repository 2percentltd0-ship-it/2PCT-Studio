...
window.SITE_CONTENT = {
  ...
  categories: {
    ...
    packaging: {
      ...
      images: [
        portfolioProject({
          title: 'Collagen Packaging System', company: 'Redfood Nature', slug: 'collagen-packaging-system',
          sector: 'Supplements · Wellness · Consumer Health',
          summary: 'A premium packaging system that communicates product benefits clearly while building a coherent visual family across formats.',
          cover: 'images/packaging/01.svg', image1: 'images/packaging/01.svg', image2: 'images/packaging/01.svg', image3: 'images/packaging/01.svg'
        }),
        portfolioProject({
            title: 'Russisches Schaschlik', company: 'Russisches Schaschlik', slug: 'premium-supplement-range',
            sector: 'Food & Beverage',
            summary: 'A bold packaging concept developed for a traditional Russian-style shashlik product aimed at the German market. The design combines a distinctive typographic identity with a high-contrast red and black colour system, creating strong shelf recognition while clearly organising preparation instructions, ingredients and nutritional information.',
            cover: 'images/packaging/02.webp', image1: 'images/packaging/02.webp', image2: 'images/packaging/02.webp', image3: 'images/packaging/02.webp'
        }),
        portfolioProject({
    ...
    print: {
      ...
      images: [
          ...
          portfolioProject({ title: 'Fonte', company: 'Fonte Drinks AG', slug: 'corporate-publication', sector: 'Beverage Brand', summary: 'A vibrant recipe booklet designed for FONTE to showcase its range of specialty beverage concentrates, syrups and latte blends. The project combines clear preparation instructions, bold product photography and a structured editorial layout. The result is an engaging and easy-to-use presentation that reflects the brand’s playful, contemporary and handcrafted identity.', cover: 'images/print/cover-fonte.webp', image1: 'images/print/fonte-01.webp', image2: 'images/print/fonte-02.webp', image3: 'images/print/fonte-03.webp' }),
          portfolioProject({ title: 'König', company: 'Client Name', slug: 'annual-report', sector: 'Corporate · Finance · Stakeholder Communication', summary: 'A clear annual report design that turns dense information and key figures into an accessible visual narrative.', cover: 'images/print/cover-konig.webp', image1: 'images/print/03.svg', image2: 'images/print/03.svg', image3: 'images/print/03.svg' }),
        portfolioProject({ title: 'Sales Presentation', company: 'Client Name', slug: 'sales-presentation', sector: 'Sales · Business Development · B2B', summary: 'A focused presentation system that supports the conversation with clear hierarchy, persuasive structure and consistent visual storytelling.', cover: 'images/print/04.svg', image1: 'images/print/04.svg', image2: 'images/print/04.svg', image3: 'images/print/04.svg' }),
        portfolioProject({ title: 'Product Catalogue', company: 'Client Name', slug: 'product-catalogue', sector: 'Manufacturing · Product Range · Sales Support', summary: 'A practical catalogue design that makes a broad product range easier to compare, understand and specify.', cover: 'images/print/05.svg', image1: 'images/print/05.svg', image2: 'images/print/05.svg', image3: 'images/print/05.svg' }),
        portfolioProject({ title: 'Premium Invitation', company: 'Client Name', slug: 'premium-invitation', sector: 'Awards · Corporate Events · Personal Invitation', summary: 'A restrained invitation concept designed to feel personal, exclusive and production-ready across print and digital formats.', cover: 'images/print/06.svg', image1: 'images/print/06.svg', image2: 'images/print/06.svg', image3: 'images/print/06.svg' })
      ]
    },
