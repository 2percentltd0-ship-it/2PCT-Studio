...
const page=(title,description,canonical,rootPath)=>template.replaceAll('%%TITLE%%',escape(title)).replaceAll('%%DESCRIPTION%%',escape(description)).replaceAll('%%CANONICAL%%',canonical).replaceAll('%%ROOT%%',rootPath);
